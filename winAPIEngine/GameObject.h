...
public:
	...
	void SetAnchorPoint(CTexture* tTexture, SVector2D tScale, SVector2D tSize) {
		this->mAnchorPoint = SVector2D((tTexture->GetWidth() * tScale.mX * tSize.mX) / 2, tTexture->GetHeight() * tScale.mY * tSize.mY);
	}
